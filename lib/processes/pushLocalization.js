...
module.exports = async function(config, project, localization, format, referenceVersion=null){
    ...
    try {
        ...
        for(const item of conflictItems){
            ...
            const conflictValue = conflict.deleted ? LOG_DELETED : conflict.value;
            const myValue = item.deleted ? LOG_DELETED : item.value;
