...
function importStrings(config, data){
    ...
    return requestGraphQL(config, `
        mutation ($projectId: ID!, $locale: String!, $save: [SaveStringInput], $delete: [DeleteStringInput], $translated: Boolean) {

            importStrings(projectId: $projectId, locale: $locale, save: $save, delete: $delete, translated: $translated)
        }
    `, data)
}
