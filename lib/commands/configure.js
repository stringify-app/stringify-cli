...
module.exports = async function(config){
    ...
    console.log(
        ...
        "  5. Paste your token below or set is as " + chalk.bold("STRINGIFY_API_TOKEN") + " environment variable\n"
    )
    ...
    const answers = await inquirer.prompt([
        {
            ...
            message: 'Do you want to proceed with local configuration?',
        }
    ]);
    
    if (!answers.localConfiguration) {
      Log.success("Set your token as " + chalk.bold("STRINGIFY_API_TOKEN") + " environment variable and proceed!");
